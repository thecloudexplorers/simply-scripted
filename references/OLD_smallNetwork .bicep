...
@description('Ip address prefix for the Azure Bastion subnet.')
param bastionSubnetAddressPrefix string = '10.0.1.0/25'

@description('Id of the network security group for the Azure Bastion subnet.')
param bastionSubnetNsgId string

@description('Name of the subnet for the jump box VM')
param jumpVmSubnetName string

@description('Ip address prefix for the jump box VM')
param jumpVmAddressPrefix string = '10.0.2.0/25'

@description('Id of the network security group for the jump box VM subnet.')
param jumpVmSubnetNsgId string
    ...
    subnets: [
      {
        ...
        properties: {
          ...
          networkSecurityGroup: bastionSubnetNsgId
        }
      }
      {
        name: jumpVmSubnetName
        properties: {
          addressPrefix: jumpVmAddressPrefix
        }
      }
    ]
  }
